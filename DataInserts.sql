...
INSERT INTO `mydb`.`venta_has_productos` (`Venta_IdProducto`, `Productos_IdProducto`) VALUES ('2', '2');
INSERT INTO `mydb`.`venta_has_productos` (`Venta_IdProducto`, `Productos_IdProducto`) VALUES ('3', '3');
INSERT INTO `mydb`.`venta_has_productos` (`Venta_IdProducto`, `Productos_IdProducto`) VALUES ('1', '1');
